...
contract MutualFundV3 is ERC20Burnable, Ownable{
    ...
    function resolveState()external deadline_size_modifier{
        if(block.timestamp > interval + recentTime){
            deadline.pop();
            deadline_size-=1;
...
//contract address : 0x672efA7Ea9771204687B00E9c976f9Ab71a8ebED